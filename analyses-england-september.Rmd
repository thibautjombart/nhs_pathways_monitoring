...
NHS 111, 999, and reports through the 111-online platform. Only the last 7 weeks
of data are used, up to the 9th September 2020, i.e. one week after the school
reopenings.
...
last_date <- as.Date("2020-09-09")
first_date <- last_date - 7*7
to_keep <- pathways$date >= first_date &
  pathways$date <= last_date
pathways_recent <- pathways[to_keep, ]
